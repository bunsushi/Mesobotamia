var sumerSays = [
    ...
    `Once I had escaped the wild bull, the wild cow confronted me. (2.94)`,
    ...
    `Let our odor be the smell of leeks--let it not be the smell of turnips! (3.68)`,
    ...
    `Unique: a tall pot and a shouting statue. (4.1)`,
    `What is placed in the fire has a valuable role to play but leaves nothing behind when it's gone. (4.2)`,
    `Half a shekel is half a shekel wherever you go (?); discarded, it is a shekel belonging to the place of wild cattle and serpents. (4.3)`,
    `He holds up the sky, letting the earth dangle from his hands. (4.4)`,
    `He bears the responsibility for it. (4.5)`,
    `As a provisioner, I will come down upon those who speak proudly (?). (4.6)`,
    `All day long, oh penis, you ejaculate as if you have blood inside you, and then you hang like a damp reed. (4.7)`,
    `He who was the capturer of someone's assassin became his opponent. (4.8)`,
    `The north wind is a satisfying wind; the south wind is harmful (?) to man. The east wind is a rain-bearing wind; the west wind is greater than those who live there. The east wind is a wind of prosperity, the friend of Naram-Suen. (4.9)`,
    `Why should someone who knows something conceal it? (4.10)`,
    `My intelligence (?) has dug the ground; you will not find what I have lost! (4.11)`,
    `A goat can be made to go down into water; in beer it becomes stuck. (4.12)`,
    `He will ... which I have eaten (?). (4.13)`,
    `Oh little one who is no longer consuming milk, your mother is a wild cow yielding beer. (4.14)`,
    `He could not overcome his fears, so he cut off what was fuelling them. (4.15)`,
    `The riverbank should rejoice as though there were a flood. Enlil should rejoice as though the Tigris were at high water. (4.16)`,
    `May your favorite ... bite you. (4.17)`,
    `I want to get hold of borrowed clothes, borrowed linen, and borrowed lapis lazuli. (4.18)`,
    `The prosopis plant is how a witness should be: fruit pods come forth from it. (4.45)`,
    `A heart which does not know accounting--is that a wise heart? (4.46)`,
    `He who ploughs the fields should plough the fields; he who harvests grain should harvest grain. (4.47)`,
    `Its mouth, like a seal (?), is half; its anus is the place amongst the grass where boats are pulled from the water. (4.48)`,
    `After the serpent has been caught for him, he himself casts the incantation. (4.49)`,
    `What is it, a sheep? What is it, a stag? (4.50)`,
    `What are the dreams of a slave girl? What are the prayers of a striving (?) slave? (4.51)`,
    `Let my gifts never cease (?) in the presence of his god. (4.52)`,
    `Says the man lying on the roof to the man living in the house: "It is too bright up here!" (4.56)`,
    `The lion is tied up with (?) that of which his own house is made. (4.57)`,
    `That which the thief has taken was made by an honest man. (4.58)`,
    `To appreciate the earth is for the gods; I am merely covered in dust. (4.59)`,
    `In respect of both expenditures and capital goods, the anus is well supplied. (4.60)`,
    `Bitterness afflicted the anus; but it entered by way of the mouth. (4.61)`,
    `The anus breaks wind; talking produces excessive words. (4.62)`,
    `O ... mother, I have no water in the ferry-boat. (4.63)`
]
